package javaTest.ServerTest.UdpServer;
...
public class UdpServer {
    ...
    public void start() throws Exception {
        try(DatagramSocket socket = new DatagramSocket(PORT)){
            ...
            e.printStackTrace(); System.out.println("=====服务端关闭=====");
        }

    }

    public static void main(String[] args) throws Exception { new UdpServer().start(); }
